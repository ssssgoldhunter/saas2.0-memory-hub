...
> 实施说明：本文保留总体设计和讨论依据；可直接交给开发 AI 执行的模块、类、DDL、LiteFlow、测试和完成标准，以 [04-front-service完整重构实施方案.md](./04-front-service完整重构实施方案.md) 为准。
...
```text
02-租户银行配置字段设计.md
03-specialData契约设计.md
04-交易业务总体设计.md
05-转账业务-平安中信字段映射.md
06-消费业务-平安中信字段映射.md
07-提现业务-平安中信字段映射.md
08-退款业务-平安中信字段映射.md
09-平台付款收款-平安中信字段映射.md
10-账户查询业务设计.md
11-交易状态查询业务设计.md
12-子账户交易明细查询业务设计.md
13-平台账户交易明细查询业务设计.md
14-查询统一响应字段设计.md
15-渠道交易流水表设计.md
16-LiteFlow链路与组件设计.md
17-错误码与状态机设计.md
18-文件查询业务设计.md
```
